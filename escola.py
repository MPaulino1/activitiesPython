'''
Crie uma classe chamada Escola com os seguintes dados: nome da escola, endereço, cursos (será uma lista de cursos),
alunos (uma lista que inicializará vazia). A classe também conterá dois métodos. Uma para matricular alunos.
Receberá um objeto da classe Aluno que será inserido na lista de alunos. E uma método de exibir alunos matriculados,
que percorrerá a lista de alunos e a exibirá para o usuário.
